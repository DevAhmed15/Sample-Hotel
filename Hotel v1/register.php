...
include ('classes/person.php');
 ...
 if($_SERVER['HTTP_REFERER'] == "http://localhost/Hotel%20System/reserv.php")
{
  echo "<script> alert('Reservation is Available '); </script>";
  echo "<script> alert('You Must Register Before !.. '); </script>";
}
...
$result=$person->register($name,$add,$quest,$Ans,$ssn,$mail,$pass);
...
<div class="main">
  ...
  <input type="text" name="name" placeholder="Full Name.." class="m" required> <br />  
   <input type="text" name="add" placeholder="Address.." class="m" required> <br />
    ...
    <input type="text" name="ans" placeholder="Answer OF Question.." class="m" required> <br />
  ...
  <input type="submit" value="Register" name="submit" class="b"><br />
