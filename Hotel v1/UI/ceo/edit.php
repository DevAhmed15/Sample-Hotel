...
$resultUp=$cont->updateWorker($id,$name,$add,$ssn,$mail,$pass,$salary);
echo $resultUp;
}
...
<br />
<?php while($roww=mysqli_fetch_assoc($resSal))
{
?>
<label> Salary: </label>
<input class="inp" value="<?php echo $roww['sal_value'] ?>" name="sal" required/>
<br />
<?php } ?>
<?php } ?>
<br />
