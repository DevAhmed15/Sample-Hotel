...
$ceo = new ceo();
$result=$ceo->AddWorker($name,$add,$ssn,$mail,$pass,$salary,2);
echo $result;
}
...
<a href="../logout.php" id="log" />logout</a>         <a href="../editProf.php" id="log" />Edit Profile</a>
      ...
      <nav>
        <ul class="menu">
          ...
          <li class="current"><a href="contAdm.php">ADMINS</a></li>
...
<div class="addAdm">
<br /> 
<h2 style="width:300px;color:#fff;text-align:center;border:3px solid #000;margin:0 auto;padding:0 auto;">ADD ADMIN</h2>
  ...
  <input type="submit" value="Add" name="sub" class="b"><br />
...
<br /> 
<h2 style="width:300px;color:#fff;text-align:center;border:3px solid #000;margin:0 auto;padding:0 auto;">Edit & Delete ADMIN</h2>
  <br />
